...
<div class="col-xl-10 col-lg-12 col-md-9">
    ...
    <div class="card o-hidden border-0 shadow-lg my-5">
        ...
        <div class="card-body p-0">
                    ...
                    <div class="p-5">
                        <form class="user" method="POST" action="{{ route("save.update") }}">
                            @csrf
                            <div class="form-group">
                                <label for="NamaBarang" class="text-primary small">Nama Barang</label>
                                <input type="text" class="form-control form-control-user" id="NamaBarang" name="nama" placeholder="Masukkan Nama Barang" value="{{ $data->nama }}">
                            </div>
                            <div class="form-group">
                                <label for="JumlahSatuan" class="text-primary small">Jumlah (Satuan)</label>
                                <input type="number" class="form-control form-control-user" id="JumlahSatuan" name="jumlah_satuan" placeholder="Masukkan Jumlah dalam Pack" value="{{ $data->jumlah_satuan }}">
                            </div>
                            <div class="form-group">
