            ...
            <div class="p-5">
                <form class="user" method="POST" action="{{ route('save.barang.dua') }}">
                    ...
                    <div id="lanyardOptions" class="form-group" style="display:none;">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="lanyard_options[]" id="lanyardTali" value="Tali" checked>
                            <label class="form-check-label" for="lanyardTali">Tali</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="lanyard_options[]" id="lanyardStopper" value="Stopper" checked>
                            <label class="form-check-label" for="lanyardStopper">Stopper</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="lanyard_options[]" id="lanyardKail" value="Kail" checked>
                            <label class="form-check-label" for="lanyardKail">Kail</label>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="lanyard_options[]" id="lanyardKertas" value="Kertas" checked>
                                    <label class="form-check-label" for="lanyardKertas">Kertas</label>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="lanyard_options[]" id="lanyardKertasDob" value="Kertas Dobel">
